...
//    int lenchrom = 14; // 染色体长度(这里即为城市个数)
//    double[][] city_pos = {
//            {16.47, 96.10}
//            , {16.47, 94.44}
//            , {20.09, 92.54}
...
//            , {20.09, 92.55}
//    }; // 定义二维数组存放14个城市的X、Y坐标
//    int[][] chrom = new int[sizepop][lenchrom]; // 种群
//    int[] best_result = new int[lenchrom]; // 最佳路线
...
//        System.out.print("本程序使用遗传算法求解规模为%d的TSP问题,种群数目为:%d,进化代数为:%d\n", lenchrom, sizepop, maxgen);
//        System.out.print("得到最短路径为:%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d-->%d\n", best_result[0], best_result[1], best_result[2],
...
//        System.out.print("最短路径长度为:%lf,得到最短路径在第%d代.\n", min_distance, best_fit_index);
//        System.out.print("程序耗时:%lf秒.\n", duration);
//        return 0;
//    }
//}
